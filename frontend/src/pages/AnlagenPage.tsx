            ...
            {anlagen?.map((anlage) => (
              <TableRow key={anlage.id} hover>
                ...
                <TableCell align="right">
                  <Tooltip title={t('common.details')}><IconButton component={Link} to={`/anlagen/${anlage.id}`} size="small"><VisibilityIcon fontSize="small" /></IconButton></Tooltip>
